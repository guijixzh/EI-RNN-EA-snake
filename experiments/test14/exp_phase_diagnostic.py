...
_repod = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
sys.path.insert(0, os.path.join(_repod, 'experiments', 'test12'))
sys.path.insert(0, os.path.join(_repod, 'experiments', 'test7_series'))
sys.path.insert(0, _repod)
