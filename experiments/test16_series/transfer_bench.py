...
ENGINES = {
    '7b': ('experiments/test7_series/test7b.py', 'artifacts/test7b/test7b_best_model.pth'),
    '12': ('experiments/test12/test12.py', 'artifacts/test12/test12_econ_best_model.pth'),
}
SPACES = {
    '12x12': (12, 12),
    '15x15': (15, 15),
